...
bool auto_aim_interfaces__msg__tracker_predict__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auto_aim_interfaces.msg._tracker_predict.TrackerPredict", full_classname_dest, 55) == 0);
  }
  auto_aim_interfaces__msg__TrackerPredict * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TrackerPredict */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("auto_aim_interfaces.msg._tracker_predict");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrackerPredict");
