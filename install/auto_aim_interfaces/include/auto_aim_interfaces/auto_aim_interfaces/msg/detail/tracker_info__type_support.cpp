...
size_t size_function__TrackerInfo__armors(const void * untyped_member)
{
  (void)untyped_member;
  return 2;
}

const void * get_const_function__TrackerInfo__armors(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__TrackerInfo__armors(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrackerInfo_message_member_array[2] = {
  {
    ...
    offsetof(auto_aim_interfaces::msg::TrackerInfo, header),  // bytes offset in struct
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::TrackerInfo, armors),  // bytes offset in struct
    nullptr,  // default value
    size_function__TrackerInfo__armors,  // size() function pointer
    get_const_function__TrackerInfo__armors,  // get_const(index) function pointer
    get_function__TrackerInfo__armors,  // get(index) function pointer
    fetch_function__TrackerInfo__armors,  // fetch(index, &value) function pointer
    assign_function__TrackerInfo__armors,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
