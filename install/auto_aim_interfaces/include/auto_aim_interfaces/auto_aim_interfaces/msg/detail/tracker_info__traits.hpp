...
struct has_fixed_size<auto_aim_interfaces::msg::TrackerInfo>
  : std::integral_constant<bool, has_fixed_size<auto_aim_interfaces::msg::ArmorInfo>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<auto_aim_interfaces::msg::TrackerInfo>
  : std::integral_constant<bool, has_bounded_size<auto_aim_interfaces::msg::ArmorInfo>::value && has_bounded_size<std_msgs::msg::Header>::value> {};
