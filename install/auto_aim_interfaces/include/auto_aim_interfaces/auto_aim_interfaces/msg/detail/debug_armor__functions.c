...
auto_aim_interfaces__msg__DebugArmor__are_equal(const auto_aim_interfaces__msg__DebugArmor * lhs, const auto_aim_interfaces__msg__DebugArmor * rhs)
{
  ...
  // light_angle_1
  if (lhs->light_angle_1 != rhs->light_angle_1) {
    return false;
  }
  // light_angle_2
  if (lhs->light_angle_2 != rhs->light_angle_2) {
    return false;
  }
  // rect_area_ratio
  if (lhs->rect_area_ratio != rhs->rect_area_ratio) {
    return false;
  }
  // angle_diff
  if (lhs->angle_diff != rhs->angle_diff) {
    return false;
  }
  // light_center_offset
  if (lhs->light_center_offset != rhs->light_center_offset) {
    return false;
  }
  // is_armor
  ...
  auto_aim_interfaces__msg__DebugArmor * output)
{
  ...
  // light_angle_1
  output->light_angle_1 = input->light_angle_1;
  // light_angle_2
  output->light_angle_2 = input->light_angle_2;
  // rect_area_ratio
  output->rect_area_ratio = input->rect_area_ratio;
  // angle_diff
  output->angle_diff = input->angle_diff;
  // light_center_offset
  output->light_center_offset = input->light_center_offset;
  // is_armor
