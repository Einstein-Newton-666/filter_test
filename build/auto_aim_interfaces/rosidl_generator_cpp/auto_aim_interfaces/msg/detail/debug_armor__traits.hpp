  ...
  std::ostream & out)
{
  ...
  {
    out << "light_angle_1: ";
    rosidl_generator_traits::value_to_yaml(msg.light_angle_1, out);
    out << ", ";
  }
  ...
  {
    out << "light_angle_2: ";
    rosidl_generator_traits::value_to_yaml(msg.light_angle_2, out);
    out << ", ";
  }
  ...
  {
    out << "rect_area_ratio: ";
    rosidl_generator_traits::value_to_yaml(msg.rect_area_ratio, out);
    out << ", ";
  }
  ...
  {
    out << "light_center_offset: ";
    rosidl_generator_traits::value_to_yaml(msg.light_center_offset, out);
    out << ", ";
  }
  ...
  {
    out << "is_armor: ";
    rosidl_generator_traits::value_to_yaml(msg.is_armor, out);
  }
  out << "}";
