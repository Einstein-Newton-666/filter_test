...
#include "auto_aim_interfaces/msg/detail/enemy_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auto_aim_interfaces::msg::EnemyInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::EnemyInfo & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::EnemyInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::EnemyInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::EnemyInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EnemyInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::EnemyInfo *>(
...
static size_t _EnemyInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EnemyInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EnemyInfo__callbacks = {
...
static rosidl_message_type_support_t _EnemyInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EnemyInfo__callbacks,
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_EnemyInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, EnemyInfo)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_EnemyInfo__handle;
}
