    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'auto_aim_interfaces.msg.SendData')
            logger.debug(
...
class SendData(metaclass=Metaclass_SendData):
    ...
    def __init__(self, **kwargs):
        ...
        self.attack_choice = kwargs.get('attack_choice', int())
        self.enable_shoot = kwargs.get('enable_shoot', int())
    ...
    def __eq__(self, other):
        ...
        if self.priority != other.priority:
            return False
        if self.attack_choice != other.attack_choice:
            return False
        if self.enable_shoot != other.enable_shoot:
            return False
        return True
    ...
    def attack_choice(self):
        """Message field 'attack_choice'."""
        return self._attack_choice

    @attack_choice.setter
    def attack_choice(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'attack_choice' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'attack_choice' field must be an integer in [-2147483648, 2147483647]"
        self._attack_choice = value

    @builtins.property
    def enable_shoot(self):
        """Message field 'enable_shoot'."""
        return self._enable_shoot

    @enable_shoot.setter
    def enable_shoot(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'enable_shoot' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'enable_shoot' field must be an integer in [-2147483648, 2147483647]"
        self._enable_shoot = value
