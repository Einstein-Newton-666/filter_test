...
bool auto_aim_interfaces__msg__debug_armor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // light_angle_1
    PyObject * field = PyObject_GetAttrString(_pymsg, "light_angle_1");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->light_angle_1 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // light_angle_2
    PyObject * field = PyObject_GetAttrString(_pymsg, "light_angle_2");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->light_angle_2 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // rect_area_ratio
    PyObject * field = PyObject_GetAttrString(_pymsg, "rect_area_ratio");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->rect_area_ratio = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // angle_diff
    ...
    assert(PyFloat_Check(field));
    ros_message->angle_diff = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // light_center_offset
    PyObject * field = PyObject_GetAttrString(_pymsg, "light_center_offset");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->light_center_offset = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // is_armor
...
PyObject * auto_aim_interfaces__msg__debug_armor__convert_to_py(void * raw_ros_message)
{
  ...
  {  // light_angle_1
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->light_angle_1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "light_angle_1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // light_angle_2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->light_angle_2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "light_angle_2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // rect_area_ratio
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->rect_area_ratio);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rect_area_ratio", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // light_center_offset
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->light_center_offset);
    {
      int rc = PyObject_SetAttrString(_pymessage, "light_center_offset", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
