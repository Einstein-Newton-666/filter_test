...
#include "auto_aim_interfaces/msg/detail/armor_info__rosidl_typesupport_fastrtps_c.h"
...
using _ArmorInfo__ros_msg_type = auto_aim_interfaces__msg__ArmorInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ArmorInfo__ros_msg_type * ros_message = static_cast<const _ArmorInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ArmorInfo__ros_msg_type * ros_message = static_cast<_ArmorInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: position
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ArmorInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__ArmorInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__ArmorInfo;
    is_plain =
      (
...
static size_t _ArmorInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__ArmorInfo(
...
static message_type_support_callbacks_t __callbacks_ArmorInfo = {
