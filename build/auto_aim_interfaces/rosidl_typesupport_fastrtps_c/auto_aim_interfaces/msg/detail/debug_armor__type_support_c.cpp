  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: light_angle_1
  {
    cdr << ros_message->light_angle_1;
  }

  // Field name: light_angle_2
  {
    cdr << ros_message->light_angle_2;
  }

  // Field name: rect_area_ratio
  {
    cdr << ros_message->rect_area_ratio;
  }

  // Field name: angle_diff
  {
    cdr << ros_message->angle_diff;
  }

  // Field name: light_center_offset
  {
    cdr << ros_message->light_center_offset;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name light_angle_1
  {
    size_t item_size = sizeof(ros_message->light_angle_1);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name light_angle_2
  {
    size_t item_size = sizeof(ros_message->light_angle_2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name rect_area_ratio
  {
    size_t item_size = sizeof(ros_message->rect_area_ratio);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name angle_diff
  {
    size_t item_size = sizeof(ros_message->angle_diff);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name light_center_offset
  {
    size_t item_size = sizeof(ros_message->light_center_offset);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name is_armor
