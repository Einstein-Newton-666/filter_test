...
#include "auto_aim_interfaces/msg/detail/tracker_predict__rosidl_typesupport_fastrtps_c.h"
...
using _TrackerPredict__ros_msg_type = auto_aim_interfaces__msg__TrackerPredict;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackerPredict__ros_msg_type * ros_message = static_cast<const _TrackerPredict__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrackerPredict__ros_msg_type * ros_message = static_cast<_TrackerPredict__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_auto_aim_interfaces__msg__TrackerPredict(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrackerPredict__ros_msg_type * ros_message = static_cast<const _TrackerPredict__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrackerPredict__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__TrackerPredict(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__TrackerPredict(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__TrackerPredict;
    is_plain =
      (
...
static size_t _TrackerPredict__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__TrackerPredict(
...
static message_type_support_callbacks_t __callbacks_TrackerPredict = {
...
static rosidl_message_type_support_t _TrackerPredict__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackerPredict,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, TrackerPredict)() {
  return &_TrackerPredict__type_support;
}
