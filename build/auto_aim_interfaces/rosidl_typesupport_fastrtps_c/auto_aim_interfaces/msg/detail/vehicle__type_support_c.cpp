...
#include "auto_aim_interfaces/msg/detail/vehicle__rosidl_typesupport_fastrtps_c.h"
...
using _Vehicle__ros_msg_type = auto_aim_interfaces__msg__Vehicle;
...
static uint32_t _Vehicle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__Vehicle(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__Vehicle;
    is_plain =
      (
...
static size_t _Vehicle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__Vehicle(
