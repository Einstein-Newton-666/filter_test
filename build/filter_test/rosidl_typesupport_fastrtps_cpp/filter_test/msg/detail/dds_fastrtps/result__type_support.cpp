...
#include "filter_test/msg/detail/result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = filter_test::msg::Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const filter_test::msg::Result *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<filter_test::msg::Result *>(
    untyped_ros_message);
...
{
  return &filter_test::msg::typesupport_fastrtps_cpp::_Result__handle;
}
